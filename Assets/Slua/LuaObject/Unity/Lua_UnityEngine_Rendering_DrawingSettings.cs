...
public class Lua_UnityEngine_Rendering_DrawingSettings : LuaObject {
	...
	static public int set_perObjectData(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.PerObjectData)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.DrawingSettings),typeof(System.ValueType));
	}
}
