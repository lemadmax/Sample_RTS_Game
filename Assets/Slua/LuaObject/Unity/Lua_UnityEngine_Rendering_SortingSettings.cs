...
public class Lua_UnityEngine_Rendering_SortingSettings : LuaObject {
	...
	static public int set_criteria(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.SortingCriteria)LuaDLL.luaL_checkinteger(l, 2);
			self.criteria=v;
			setBack(l,self);
			pushValue(l,true);
			return 1;
	...
	static public int set_distanceMetric(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.DistanceMetric)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.SortingSettings),typeof(System.ValueType));
	}
}
