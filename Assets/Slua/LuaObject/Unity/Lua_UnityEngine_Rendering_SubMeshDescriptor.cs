...
public class Lua_UnityEngine_Rendering_SubMeshDescriptor : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			a3 = (UnityEngine.MeshTopology)LuaDLL.luaL_checkinteger(l, 4);
	...
	static public int set_topology(IntPtr l) {
		try {
			...
			v = (UnityEngine.MeshTopology)LuaDLL.luaL_checkinteger(l, 2);
			self.topology=v;
			setBack(l,self);
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.SubMeshDescriptor),typeof(System.ValueType));
	}
}
