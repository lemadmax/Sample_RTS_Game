...
public class Lua_UnityEngine_Rendering_SupportedRenderingFeatures : LuaObject {
	...
	static public int set_reflectionProbeModes(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.SupportedRenderingFeatures.ReflectionProbeModes)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_defaultMixedLightingModes(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.SupportedRenderingFeatures.LightmapMixedBakeModes)LuaDLL.luaL_checkinteger(l, 2);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_terrainDetailUnsupported(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Rendering.SupportedRenderingFeatures self=(UnityEngine.Rendering.SupportedRenderingFeatures)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.terrainDetailUnsupported);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_terrainDetailUnsupported(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			bool v;
			checkType(l,2,out v);
			self.terrainDetailUnsupported=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"terrainDetailUnsupported",get_terrainDetailUnsupported,set_terrainDetailUnsupported,true);
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.SupportedRenderingFeatures));
	}
}
