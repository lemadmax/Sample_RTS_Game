...
public class Lua_UnityEngine_Rendering_RasterState : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			a1 = (UnityEngine.Rendering.CullMode)LuaDLL.luaL_checkinteger(l, 2);
			System.Int32 a2;
	...
	static public int set_cullingMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.CullMode)LuaDLL.luaL_checkinteger(l, 2);
			self.cullingMode=v;
			setBack(l,self);
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.RasterState),typeof(System.ValueType));
	}
}
