	...
	static public int AddBatch(IntPtr l) {
		try {
			...
			if(argc==12){
				...
				a5 = (UnityEngine.Rendering.ShadowCastingMode)LuaDLL.luaL_checkinteger(l, 6);
				System.Boolean a6;
				...
				var ret=self.AddBatch(a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				var ret=self.AddBatch(a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AddBatch to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
