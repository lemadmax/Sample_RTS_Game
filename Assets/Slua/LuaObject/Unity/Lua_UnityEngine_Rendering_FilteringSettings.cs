...
public class Lua_UnityEngine_Rendering_FilteringSettings : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			System.Nullable<UnityEngine.Rendering.RenderQueueRange> a1;
			checkNullable(l,2,out a1);
			System.Int32 a2;
			...
			o=new UnityEngine.Rendering.FilteringSettings(a1,a2,a3,a4);
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.FilteringSettings),typeof(System.ValueType));
	}
}
